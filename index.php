...
<html lang="en">
  ...
  <?php 
    ...
    <header class="header__ATN">
      <div class="container">
        <nav class="navbar navbar-expand-lg navbar-light">
          <a class="navbar-brand" href="./index.html">ATN Dolls </a>
          <button
    ...
    <!-- HEADER END -->
    <div class="container-fluid p-5 bg-dark light text-white text-center">
      <h1>Doll model toy set</h1>
      <p>If you are thinking about what to give your baby girl, the doll model set is a great gift not to be missed</p>
              ...
              <div class="card-body">
                ...
                <div class="product__edit">
                  <a href="./update.php/<?php echo $product["id"]; ?>"
                   class="btn btn-success w-100 mb-1">Edit</a>
                  <button
